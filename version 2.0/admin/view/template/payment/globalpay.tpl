            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-globalpay" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="globalpay_processed_status_id" id="input-order-status" class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == $globalpay_processed_status_id) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="globalpay_sort_order" value="<?php echo $globalpay_sort_order; ?>" placeholder="<?php echo $globalpay_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
